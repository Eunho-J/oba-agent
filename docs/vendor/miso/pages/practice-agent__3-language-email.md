---
title: "이메일 작성 에이전트(3개 국어)"
source: "https://console.miso.gs/learn/practice-agent/3-language-email"
synced_at: "2026-05-30"
nav_title: "이메일 작성 에이전트(3개 국어)"
---
...
기본 값으로 선택된 GenAI 모델을 클릭하면 현재 사용할 수 있는 GenAI 모델들의 목록이 출력됩니다. 이 모델들은 미소가 설치된 환경과 조직에 따라 다를 수 있습니다. 자신의 환경에서 사용하기 적절한 모델을 선택합니다. 이 예제에서는 Claude 3.5 Sonnet 모델로 진행하겠습니다.
...
이제 프롬프트를 작성해 보겠습니다. 좌측 프롬프트 영역에 위의 3개국어 이메일 작성 프롬프트를 복사하여 붙여 넣습니다. 왜 이런 형식으로 프롬프트를 작성하였는지 궁금하신 분들은 프롬프트 작성 가이드에서 관련 내용을 확인해 보실 수 있습니다
...
모델 추가하기 버튼을 클릭하면 여러 GenAI 모델에게 동일한 입력을 제공한 후 "각각의 답변 결과를 받아 볼 수 있습니다." 이 기능을 활용하면 여러 모델들을 비교 검토하여 가장 적절한 응답을 제공하는 모델을 빠르게 선별할 수 있습니다.
